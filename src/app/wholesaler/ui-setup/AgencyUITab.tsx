...
export default function AgencyUITab() {
  ...
  const handleSave = async () => {
    ...
    setIsSaving(false);
    alert('Agency UI settings saved successfully!');
  };
    ...
    <div className="space-y-6">
      ...
      <div className="card-modern p-6">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Agency UI Settings</h2>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
              Customize the branding and appearance for agency portal
            </p>
          </div>
