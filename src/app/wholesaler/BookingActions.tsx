...
const BookingActions: React.FC<Props> = ({ reservation, onViewDetails }) => (
  <aside className="w-full sm:col-span-1 bg-gray-50 dark:bg-gray-800 p-4 border-l border-gray-100 dark:border-gray-700">
    ...
    {/* mobile: 5 cols with extra horizontal gap; sm+: 4 cols with original gap */}
    <div className="grid grid-cols-5 gap-x-12 sm:grid-cols-4 sm:gap-x-4 gap-y-6 mt-3 text-[#1a7ef7]">
      <FaTimes title="Cancel" className="cursor-pointer text-3xl" />
      <FaEdit title="Edit" className="cursor-pointer text-3xl" />
