...
const AcceptAppointmentModal: React.FC<Props> = ({
  isOpen,
  appointment,
  onClose,
  onUpdateSuccess,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const payload = {
      status: "approved",
      adminNotes: adminNotes || "Approved. Ready for visa processing.", // Default
    };
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errData.message || "Failed to approve appointment.");
      }
        ...
        <form onSubmit={handleSubmit}>
          <div className="p-6 space-y-4">
            <p className="text-sm text-gray-600 dark:text-gray-300">
              You are about to approve the visa appointment for{" "}
              <strong>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="e.g., Approved. Ready for visa processing."
          ...
          <div className="flex justify-end items-center gap-3 p-4 bg-gray-50 dark:bg-gray-800 border-t dark:border-gray-700 rounded-b-lg">
            ...
            <button
              type="submit"
              disabled={loading}
              className="px-4 py-2 text-sm font-medium text-white bg-green-600 rounded-md hover:bg-green-700 disabled:bg-green-300 flex items-center gap-2"
            >
