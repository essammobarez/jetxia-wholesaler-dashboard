           ...
           <table className="min-w-full divide-y divide-gray-200">
             <thead className="bg-gray-50">
               <tr>
                 ...
                 <th className="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Joined Date</th>
             ...
             <tbody className="bg-white divide-y divide-gray-200">
               {salesList.map(user => (
                 <tr key={user._id} className="hover:bg-gray-50">
                   ...
                   <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">{user.phone}</td>
           ...
           <div className="p-8">
             <div className="text-center mb-6 space-y-2">
               ...
               <p className="text-gray-500">
                 Updating for <span className="font-semibold">{editingUser.Name}</span>
               </p>
             </div>
