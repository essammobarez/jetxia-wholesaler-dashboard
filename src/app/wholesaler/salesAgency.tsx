...
const REGISTER_URL = `${process.env.NEXT_PUBLIC_BACKEND_URL}sales/create-by-sales`
...
export default function RegistrationForm() {
  ...
  // ✨ Password field removed from user state
  ...
  const resetAll = () => {
    ...
    // ✨ Password field removed from reset
    setUser({
      title: '',
      firstName: '',
      lastName: '',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // ✨ Password is automatically excluded from payload as it's not in the user state
    const payload: any = {
      ...agency,
      ...user,
      emailId: userEmail,
  ...
  const agencyFields = [
    ...
    { name: 'country', label: 'Country', type: 'autocomplete', options: countryList, required: true },
    ...
    { name: 'businessCurrency', label: 'Business Currency', type: 'select', options: currencyList },
    { name: 'vat', label: 'VAT', type: 'text' },
  ]

  // ✨ Password field removed from the form configuration
  const userFields = [
