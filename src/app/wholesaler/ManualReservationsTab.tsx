...
// UPDATE: Changed the import from the placeholder to the actual Agency component.
...
const ManualReservation: NextPage = () => {
    ...
    // UPDATE: Added state to manage agency data received from the Agency component.
    const [selectedAgencyId, setSelectedAgencyId] = useState('');
    const [agencyName, setAgencyName] = useState('');
    const [agencyWalletBalance, setAgencyWalletBalance] = useState<number | null>(null);
    const [agencyMarkup, setAgencyMarkup] = useState<number | null>(null);
    ...
    // UPDATE: Added a handler to receive and set agency data from the child component.
    const handleAgencyDataSelect = (data: { walletBalance: number; markup: number }) => {
        setAgencyWalletBalance(data.walletBalance);
        setAgencyMarkup(data.markup);
    };
            ...
            <div className="min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-10">
                <div className="max-w-5xl mx-auto">
                    ...
                    <main className="space-y-8">
                        {/* 1. Agency & Destination */}
                        <div className="space-y-8">

                            {/* UPDATE: Replaced ResellerAndAgent with the Agency component and passed required props. */}
                            <Agency
                                selectedAgencyId={selectedAgencyId}
                                setSelectedAgencyId={setSelectedAgencyId}
                                agencyName={agencyName}
                                setAgencyName={setAgencyName}
                                onAgencyDataSelect={handleAgencyDataSelect}
                            />

                            {/* UPDATE: Passed agency wallet and markup data down to the Destination component. */}
                            <Destination
                                agencyWalletBalance={agencyWalletBalance}
